            ...
            {orders.map((order, index) => (
              <React.Fragment key={index}>
                <tr className="border-b">
                  ...
                  <td className="p-2 sm:p-3">
                    <button onClick={() => toggleRow(index)} className="flex items-center text-blue-600">
                  ...
                  <tr className="border-b">
                    <td colSpan="5" className="p-2 sm:p-3 bg-gray-50">
                      {order.products.map((product, i) => (
                        <div key={i} className="flex flex-col sm:flex-row items-start sm:items-center border-b pb-4 mb-4 last:border-b-0 last:mb-0 last:pb-0">
                          <img
                            ...
                            <div className="flex items-center mt-2">
                              {[...Array(5)].map((_, starIndex) => (
                                <Star
                                  ...
                                  onClick={() => handleStarClick(order.id, i, starIndex + 1)}
                                />
                              ))}
                              <input
                                type="text"
                                ...
                                onChange={(e) =>
                                  handleCommentChange(order.id, i, e.target.value)
                                }
